...
struct TableStruct_quiche_2fquic_2fcore_2fproto_2fcrypto_5fserver_5fconfig_2eproto {
...
extern const ::google::protobuf::internal::ClassDataLite<30> QuicServerConfigProtobuf_class_data_;
...
extern const ::google::protobuf::internal::ClassDataLite<41> QuicServerConfigProtobuf_PrivateKey_class_data_;
}  // namespace quic
namespace google {
namespace protobuf {
}  // namespace protobuf
...
class QuicServerConfigProtobuf_PrivateKey final : public ::google::protobuf::MessageLite
/* @@protoc_insertion_point(class_definition:quic.QuicServerConfigProtobuf.PrivateKey) */ {
 public:
  ...
  inline void Swap(QuicServerConfigProtobuf_PrivateKey* PROTOBUF_NONNULL other) {
...
class QuicServerConfigProtobuf final : public ::google::protobuf::MessageLite
/* @@protoc_insertion_point(class_definition:quic.QuicServerConfigProtobuf) */ {
 public:
  ...
  inline void Swap(QuicServerConfigProtobuf* PROTOBUF_NONNULL other) {
    if (other == this) return;
    if (::google::protobuf::internal::CanUseInternalSwap(GetArena(), other->GetArena())) {
      InternalSwap(other);
    } else {
