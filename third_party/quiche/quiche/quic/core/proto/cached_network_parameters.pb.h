...
#define PROTOBUF_INTERNAL_EXPORT_quiche_2fquic_2fcore_2fproto_2fcached_5fnetwork_5fparameters_2eproto
...
struct TableStruct_quiche_2fquic_2fcore_2fproto_2fcached_5fnetwork_5fparameters_2eproto {
  static const ::uint32_t offsets[];
};
namespace quic {
enum CachedNetworkParameters_PreviousConnectionState : int;
extern const uint32_t CachedNetworkParameters_PreviousConnectionState_internal_data_[];
...
extern const ::google::protobuf::internal::ClassDataLite<29> CachedNetworkParameters_class_data_;
}  // namespace quic
namespace google {
namespace protobuf {
template <>
...
class CachedNetworkParameters final : public ::google::protobuf::MessageLite
/* @@protoc_insertion_point(class_definition:quic.CachedNetworkParameters) */ {
 public:
  ...
  inline void Swap(CachedNetworkParameters* PROTOBUF_NONNULL other) {
